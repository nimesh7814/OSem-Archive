        ...
        <ScrollArea className="flex-1 min-h-0">
          ...
          <div className="p-10 space-y-10">
            <div>
              ...
              <p className="text-base text-gray-600 font-medium">Define an area to retrieve specific data for particular time range.</p>
            </div>
            ...
            <div className="space-y-8">
                ...
                {importedFileName && (
                  <div className="flex items-center justify-between rounded-2xl border border-indigo-100 bg-indigo-50/70 px-4 py-3">
                    <div className="min-w-0">
                      <p className="text-[10px] font-black uppercase tracking-[0.22em] text-indigo-500">Imported file</p>
                      <p className="mt-1 truncate text-sm font-bold text-indigo-900">{importedFileName}</p>
                    </div>
                    <Button
                      variant="ghost"
                      size="icon"
              ...
              <div className="space-y-3">
                <Label className="text-xs font-bold text-gray-500 uppercase tracking-widest ml-1">Sensors</Label>
                <SensorSelector selected={filters.sensorTypes} onToggle={onToggleSensor} className="w-full h-14" />
              </div>
            ...
            <AnimatePresence>
              {searchResult && (
                ...
                >
                  ...
                  <ExportControls
                    onExport={(format) => onExport(format, 'Custom Selection')}
                  ...
                  {isExporting && (
                    <div className="flex items-center justify-between rounded-2xl border border-blue-100 bg-blue-50/60 px-4 py-3">
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                          <p className="text-[10px] font-black uppercase tracking-[0.22em] text-blue-500">Downloading</p>
                          <p className="truncate text-sm font-bold text-blue-900">
                            {currentExportingSensor ? `${currentExportingSensor}...` : 'Preparing export...'}
                          </p>
                        </div>
                      </div>
