...
const schema = z.object({
	...
	ARCHIVE_API_URL: z.string().url().optional(),
	ARCHIVE_API_INTERNAL_URL: z.string().url().optional(),
	...
	DISCOURSE_URL: z.union([z.string().url(), z.literal('')]),
})
...
export function getEnv() {
	return {
		...
		ARCHIVE_API_URL:
			process.env.ARCHIVE_API_URL || 'http://localhost:8001',
