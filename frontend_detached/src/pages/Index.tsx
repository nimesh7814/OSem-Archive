...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#d4f1db] overflow-x-hidden font-sans antialiased">
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-20">
        ...
        >
          <div className="space-y-6">
            ...
            <h1 className="text-6xl md:text-7xl font-extrabold tracking-tight text-[#152729] leading-[1.1]">
              OSeM Archive
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 max-w-2xl mx-auto leading-relaxed font-medium tracking-tight">
              Data Retrival Made Easy 
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-8">
            ...
            >
              <div className="h-14 w-14 bg-[#d4f1db] rounded-2xl flex items-center justify-center mb-6 group-hover:bg-blue-600 transition-colors">
                <Table className="w-7 h-7 text-[#387218] group-hover:text-white transition-colors" />
              </div>
              ...
              <div className="flex items-center text-[#387218] font-bold tracking-tight">
            ...
            >
              <div className="h-14 w-14 bg-[#d4f1db] rounded-2xl flex items-center justify-center mb-6 group-hover:bg-blue-600 transition-colors">
                <Map className="w-7 h-7 text-[#152729] group-hover:text-white transition-colors" />
              </div>
              ...
              <div className="flex items-center text-[#152729] font-bold tracking-tight">
